...
public enum SystemReloader {
    public static let configChangedNotification = Notification.Name("io.github.masato2513.Contextory.configChanged")
    public static let finderExtensionBundleIdentifier = "io.github.masato2513.Contextory.Extension"
    ...
    public static func registerFinderExtension(
        ...
        let extensionURL = appBundleURL
            ...
            .appendingPathComponent("ContextoryFinderExtension.appex", isDirectory: true)
