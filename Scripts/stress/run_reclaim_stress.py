...
APP_PATH = "/Applications/右键助手.app"
APP_BIN_FRAGMENT = "右键助手.app/Contents/MacOS/Contextory"
...
def kill_host():
    ...
    subprocess.run(["pkill", "-9", "-f", "ContextoryFinderExtension"], check=False)
...
def main(argv: list[str]) -> int:
    ...
    seeded = seed_orphans(args.bogus_pid, args.orphans, str(target))
